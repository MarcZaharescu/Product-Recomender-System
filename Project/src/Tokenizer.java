...
public class Tokenizer {
	...
	public ArrayList<String> removeStopWords(List<String> inputList)
	{
	    ...
	    // create a word list
	    String[] temp = { "a", "about", "above", "across", "after", 
				...
				"different", "differently", "do", "does", "done", "down",
				...
				"pointed", "pointing", "points", "present",
				"presented", "presenting", "presents", "problem", "problems",
				"put", "puts", "q", "r", "really", "right",
